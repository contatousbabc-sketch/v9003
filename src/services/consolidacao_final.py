...
# -*- coding: utf-8 -*-
"""
ARQV18 Enhanced v2.0 - Consolidação Final Ultra-Robusta
...
<head>
    ...
    <title>Relatório ARQV18 - {session_id}</title>
    <style>
...
"""
    ...
    def _generate_minimal_report(self, relatorio: Dict[str, Any], session_id: str) -> str:
        ...
        content = f"""RELATÓRIO MÍNIMO - ARQV18 Enhanced v2.0
========================================
